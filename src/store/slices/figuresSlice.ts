...
export const selectFigureById = (state: { figures: FigureState }, id: string) =>
  state.figures.figures.find((figure) => figure.id === id);

export const { addFigure, deleteFigure, updateFigure } = figuresSlice.actions;
